                                                                     ...
                                                                     <div class="row">
                                                                         ...
                                                                         <div class="col-lg-12 mb-3">
                                                                             ...
                                                                             <ul>
                                                                                 ...
                                                                                 <li>
                                                                                     <a href="#play">
                                                                                         <i class=" bx bxs-video me-1 text-danger fs-1"></i>
                                                                                         {{ $file->file_name }}
                                                                                     </a>
                                                                                 ...
                                                                                 <li>
                                                                                     <a href="#play">
                                                                                         <i class=" bx bxs-music me-1 text-danger fs-1"></i>
                                                                                         {{ $file->file_name }}
                                                                                     </a>
                                                                                     <br>
                                                                                     <audio controls>
                                                                                 ...
                                                                                 @elseif($file->category == 'IMAGE')
                                                                                 <li>
                                                                                     <a href="#play">
                                                                                         <i class=" bx bxs-image me-1 text-danger fs-1"></i>
                                                                                         {{ $file->file_name }}
                                                                                     </a>
                                                                                     <br>
                                                                                     <img src="{{ asset('uploads/attachments/' . $file->sys_file_name) }}" alt="Image" class="img-fluid">
                                                                                 </li>
                                                                                 @elseif($file->category == 'LINK')
                                                                                 <li>
                                                                                     <a href="{{ $file->sys_file_name }}" target="_blank">
                                                                                         <i class=" bx bx-link me-1 text-danger fs-1"></i>
                                                                                         {{ $file->file_name }}
                                                                                     </a>
                                                                                 </li>
                                                                                 @endif
