...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h2 class="mb-2 mx-2">Action is Unauthorized</h2>
            <p class="mb-4 mx-2">Oops! 😖 The requested Action currently prohibited.</p>
            <a href="{{ route('dashboard') }}" class="btn btn-primary">Back to home</a>
            <div class="mt-3">
                <img src="https://cdn.dribbble.com/users/2095973/screenshots/5404026/media/0a3a754bf21672f4a60e14661951ea5c.gif" alt="page-misc-error-light" width="500" class="img-fluid" data-app-dark-img="illustrations/page-misc-error-dark.png" data-app-light-img="illustrations/page-misc-error-light.png">
            </div>
        </div>
    </div>
